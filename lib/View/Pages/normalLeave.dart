...
class NormalLeavePage extends StatelessWidget {
  NormalLeavePage({
    super.key,
    required this.name,
              ...
              Center(
                child: ElevatedButton(
                  onPressed: () {
                    if (controller.reason.text.isEmpty ||
                    ...
                    } else if (Global.leaveDuration > Global.leaveBalance &&
                        Global.leaveBalance < controller.dayDuration) {
                      Get.snackbar(
                      ...
                      sendNotification(Global.managerID, 'لديـك طلـبات إجـازة');
                    }
                  },
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Colors.green.shade300,
